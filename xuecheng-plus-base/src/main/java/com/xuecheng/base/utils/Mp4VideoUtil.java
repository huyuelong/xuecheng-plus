...
//        ProcessBuilder builder = new ProcessBuilder();
//        builder.command("D:\\SOFTS\\Notepad++\\notepad++.exe");
//        //将标准输入流和错误输入流合并，通过标准输入流程读取信息
//        builder.redirectErrorStream(true);
//        Process p = builder.start();

        //ffmpeg的路径
        String ffmpeg_path = "D:\\94991\\Documents\\ffmpeg-7.0.2-essentials_build\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\94991\\下载\\1a.avi";
        //转换后mp4文件的名称
        String mp4_name = "1a_1.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\94991\\下载\\1a_1.mp4";
        //创建工具类对象
